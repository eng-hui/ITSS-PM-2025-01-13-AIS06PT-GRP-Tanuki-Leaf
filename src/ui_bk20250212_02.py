...
class Application:
    ...
    def capture_gesture_action(self):
        ...
        # Register brightness adjustment gestures
        if gesture_name == "IncreaseBrightness":
            self.gesture_lib.add_gesture(side, "IncreaseBrightness", vectors)
        elif gesture_name == "DecreaseBrightness":
            self.gesture_lib.add_gesture(side, "DecreaseBrightness", vectors)
